        ...
        >
            <div className="">
                <div className="">
                    ...
                    <input type="text" name="name" id="name" autoComplete="name" placeholder="Mahmoud Ayman.." className="text-field" />
                </div>
                <div className="">
                    <label htmlFor="email" className="label">
                        E-mail
                    </label>
                    <input type="text" name="email" id="email" autoComplete="name" placeholder="Mahmoud Ayman.." className="text-field" />
                </div>
            </div>
        </form>
      </div>
